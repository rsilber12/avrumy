...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4 sm:px-6 py-8 sm:py-0">
      ...
      >
        <p className="text-foreground text-2xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-light leading-[3] sm:leading-[3.2] md:leading-[3.4] tracking-tight">
          <AnimatedText text="We are Avrumy," delay={500} speed={55} storageKey="line1" />
          <br />
          <AnimatedText text="a creative design studio" delay={1400} speed={50} storageKey="line2" />
          <br />
          <AnimatedText text="located in New York City" delay={2900} speed={50} storageKey="line3" />
        </p>
      </div>
      ...
      <nav className="mt-2 sm:mt-4">
        <ul className="flex flex-col md:flex-row items-center gap-4 sm:gap-6 md:gap-12 text-base sm:text-lg tracking-tight font-sans">
          ...
          <li 
            className="opacity-0 animate-fade-in"
            style={{ animationDelay: "4.7s", animationFillMode: "forwards" }}
          >
          ...
          <li 
            className="opacity-0 animate-fade-in"
            style={{ animationDelay: "4.9s", animationFillMode: "forwards" }}
          >
          ...
          <li 
            className="opacity-0 animate-fade-in"
            style={{ animationDelay: "5.1s", animationFillMode: "forwards" }}
          >
